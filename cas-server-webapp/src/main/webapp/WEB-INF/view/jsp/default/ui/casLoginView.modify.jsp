  ...
  <div class="box fl-panel" id="login">
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row check">
                        <input type="checkbox" name="rememberMe" id="rememberMe" value="true" /> <label for="rememberMe">一周之内免登录</label>
                    </div>
            ...
            <div id="sidebar">
				...
				<br><br><br><br><br><br>
                <font size="3"><spring:message code="screen.welcome.security" /></font>
